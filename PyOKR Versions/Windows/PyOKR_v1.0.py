...
class Ui_MainWindow(object):
    ...
    def Stim_Speed(self):
        global speed
        speed = self.StimSpeedInput.text()
    ...
    def Bot_Super(self):
        ...
        b = plt.scatter(etm_bot_final["X"],etm_bot_final[wave],color='r',s=300,picker=100)
    ...
    def Top_Super(self):
        fig, ax = plt.subplots()
        a = plt.plot(fd["X"],fd[wave],color='blue',picker = 10)[0]
        b = plt.scatter(etm_top_final["X"],etm_top_final[wave],color='g',s=200,picker=100)
    ...
    def setupUi(self, MainWindow):
        ...
        self.FinalAnalysisButton.clicked.connect(self.Analyze)
        ...
        self.FinalExportButton.clicked.connect(self.DistSet)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stimDirection_2.setText(_translate("MainWindow", "Output file:"))
