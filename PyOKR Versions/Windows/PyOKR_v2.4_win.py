...
#Formation of UI via PyQt Main window initialization
class Ui_MainWindow(object):
    ...
    #File and folder browsers designed in PySimpleGUI, no longer necessary
    """ 
    ...
    def Top_Super(self):
        fig, ax = plt.subplots()
        a = plt.plot(fd["X"],fd[wave],color='blue',picker = 10,zorder=1)[0]
        b = plt.scatter(etm_bot_final["X"],etm_bot_final[wave],color='g',s=200,picker=100,zorder=2,alpha=0.8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.InitPlotLabel.setText(_translate("MainWindow", "File settings:"))
...
#Safely close application following X button (compatible with Spyder)
def window():
