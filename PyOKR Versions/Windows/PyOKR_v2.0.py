...
ETM Analysis Method with GUI v2.0
December 29, 2022
...
class Ui_MainWindow(object):
    ...
    def Final_Analysis(self):
        ...
        rank = Point_list()
        ccw = CCW_select(rank)
        fit = Poly_fit(ccw,fd,5,10,speed)
    ...
    def TableRead(self):
        headings = list(final_w_averages.columns.values)      
        
        values = final_w_averages.values.tolist()
        #print(values)
        
        sg.theme("DarkBlue")
        sg.set_options(font=("Arial", 10))
        
        layout = [[sg.Table(values=values, headings=headings, expand_x=True,expand_y=True, vertical_scroll_only=False,auto_size_columns=True, justification='left', key='-TABLE-')],]
    ...
    def setupUi(self, MainWindow):
        ...
        self.PolySpinBox.setProperty("value", 5)
        ...
        self.InitPlotButton.clicked.connect(self.direction_find)
        self.InitPlotButton.clicked.connect(self.epoch_find)
        self.InitPlotButton.clicked.connect(self.Stim_Speed)
        self.InitPlotButton.clicked.connect(self.InitialETM)
        
        self.InitPlotLayout.addWidget(self.InitPlotButton)
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.Top_Bot_init)
        self.pushButton.clicked.connect(self.Top_Bot)
        self.pushButton.clicked.connect(self.TwoDGraph)
        ...
        self.actionExit.triggered.connect(self.WD_Button)
        self.actionExit.triggered.connect(self.clicked_refresh)
  
        self.action_Open = QtWidgets.QAction(MainWindow)
        self.action_Open.setObjectName("action_Open")
        self.action_Open.triggered.connect(self.CSV_Button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "View current dataset"))
        ...
        self.InitPlotButton.setText(_translate("MainWindow", "View ETM wave"))
        self.pushButton.setText(_translate("MainWindow", "View Top and Bottom wave"))
